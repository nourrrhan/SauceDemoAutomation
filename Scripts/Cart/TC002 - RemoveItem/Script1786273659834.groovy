...
WebUI.click(findTestObject('Object Repository/Cart/removeButton'))
...
// Verify the product name is no longer present in the cart page
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Products/productName'), 10)
